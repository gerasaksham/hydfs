...
// write utils to append counter in filename - Done
// modify the write file to server code to use the utils - Done
// make a filemap - Done
// write a function to append file on server - Done
